...
urlpatterns = [
    ...
    path('review_application/<int:application_id>/', views.review_application, name='review_application'),
    path('review_application_step2/<int:application_id>/', views.review_application_step2, name='review_application_step2'),
]
